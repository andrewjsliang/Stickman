...
g = Game()
platform1 = PlatformSprite(g, PhotoImage(file="long_platform.gif"), 0, 480, 100, 10)
platform2 = PlatformSprite(g, PhotoImage(file="long_platform.gif"), 150, 440, 100, 10)
platform3 = PlatformSprite(g, PhotoImage(file="long_platform.gif"), 300, 400, 100, 10)
platform4 = PlatformSprite(g, PhotoImage(file="long_platform.gif"), 300, 160, 100, 10)
platform5 = PlatformSprite(g, PhotoImage(file="medium_platform.gif"), 175, 350, 66, 10)
platform6 = PlatformSprite(g, PhotoImage(file="medium_platform.gif"), 50, 300, 66, 10)
platform7 = PlatformSprite(g, PhotoImage(file="medium_platform.gif"), 170, 120, 66, 10)
platform8 = PlatformSprite(g, PhotoImage(file="medium_platform.gif"), 45, 60, 66, 10)
platform9 = PlatformSprite(g, PhotoImage(file="small_platform.gif"), 170, 250, 32, 10)
platform10 = PlatformSprite(g, PhotoImage(file="small_platform.gif"), 230, 200, 32, 10)
...
door = DoorSprite(g, PhotoImage(file="door1.gif"), 55, 30, 40, 35)
